...
const REFERENTNE_CINJENICE = [
  ...
  "- Rok dostave: 1–2 radna dana od otpreme (ne od narudžbe); vikendi i blagdani se ne računaju",
  ...
  "- SJEDI 5 program vjernosti: 5 prodanih udžbenika = besplatna dostava za taj nalog otkupa, 8 = 5% popust na kupnju, 11 = 10% popust na cijelu kupnju. Bodovi se automatski primjenjuju na sljedeću narudžbu putem webshopa.",
  ...
  "- Fizički otkup u poslovnici: donijeti udžbenike za srednju školu i osobnu iskaznicu. Otkupljujemo udžbenike za srednju školu, strane jezike i književnost. Ne otkupljujemo osnovnoškolsko gradivo jer je besplatno, niti oštećene/fotokopirane primjerke.",
  "- Naručivanje udžbenika: putem webshop tražilice na antikvarijat-libar.com ili emailom na info@antikvarijat-libar.com",
  "- Provjera dostupnosti knjiga: webshop tražilica i pretraživanje po naslovu, autoru ili ISBN, dostupnost na stranici artikla. Za kompletan popis udžbenika po razredima, posjetite webshop.",
